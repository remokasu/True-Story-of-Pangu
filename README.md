# 盘古之殇：ファーウェイ・ノア盤古大規模モデル研究開発の辛酸と暗黒

皆様へ。

私は、ファーウェイのノアズアーク研究所の従業員であり、盤古(Pangu)大規模言語モデルチームに所属している。
...
この時期と同じ頃、阿里巴巴(Alibaba)や智譜（Zhipu）など国内の他の企業はGPU上で訓練を行い、すでに正しい方法を模索し出していたため、盤古と競合製品との差はますます大きくなっていった。内部で一から訓練した230Bのdenseモデルも様々な理由で訓練に失敗し、プロジェクトの状況はほぼ絶望的な状態に陥った。いくつかのノードのプレッシャーと内部からの盤古に対する強い疑問に直面し、チームの士気は極限まで低下した。チームは計算リソースが極めて限られた中で、多くの努力と苦闘を重ねた。例えば、チームは偶然、当時の38B MoEが期待されたMoEの効果を発揮していないことを発見した。そこでMoEパラメータを除去し、13Bのdenseモデルに戻した。38BのMoEは非常に初期のpangu alpha 13Bに由来し、アーキテクチャが相対的に遅れていたため、チームは一連の操作を行った。例えば、絶対位置エンコーディングからropeへの切り替え、biasの除去、rmsnormへの切り替えなどである。同時に、tokenizerのいくつかの失敗と語彙表変更の経験を踏まえ、このモデルの語彙表も王雲鶴の小型モデル実験室の7Bモデルで使用されている語彙表に変更された。その後、この13Bモデルは拡張継続訓練を行い、第二世代の38B denseモデルとなった（数ヶ月間、このモデルは主要な盤古の中位モデルであった）。かつては一定の競争力を持っていた。しかし、より大きな135Bモデルはアーキテクチャが遅れており、語彙表の変更によるモデルの損傷も大きく（後の分析で、当時変更した継ぎ接ぎの語彙表にはより深刻なバグがあることが判明）、継続訓練後も千問（Qianwen）など当時の国内先進モデルとは大きな差があった。この時、内部からの疑問の声と上層部からのプレッシャーもますます大きくなっていった。チームの状態はほぼ絶望的な状況に陥っていた。

このような状況下で、王雲鶴と彼の小型モデル実験室が動き出した。彼らは旧135Bのパラメータを継承・改造したと主張し、わずか数百Bのデータで訓練しただけで、各指標が平均10ポイント程度向上したと言った。実際には、これが彼らが大規模モデルに「套壳」を適用した最初の傑作だった。ファーウェイの「素人が専門家を指導する」体制により、指導部はこのようなでたらめなことに全く概念がなく、きっと何かアルゴリズムの革新があったのだろうとしか思わなかった。内部分析によると、彼らは実際にはQwen 1.5 110Bを継続訓練したもので、層を追加し、FFN次元を拡張し、盤古π論文のいくつかのメカニズムを追加して、約135Bのパラメータに到達させたものだった。実際、旧135Bは107層だったが、このモデルはわずか82層で、各種設定も全て異なっていた。新しい出所不明の135Bは訓練後も多くのパラメータの分布がQwen 110Bとほぼ完全に同じだった。モデルコードのクラス名さえ当時は「Qwen」のままで、名前を変える手間すら惜しんでいた。その後、このモデルがいわゆる135B V2となった。そして、このモデルは当時多くの下流部門、さらには外部顧客にも提供された。
...
2024年末から2025年初めにかけて、Deepseek v3とr1が発表された後、その素晴らしい技術レベルによって、チームは巨大な衝撃を受け、さらに大きな疑念にさらされた。そこで流行に追いつくため、盤古はDeepseekのモデルサイズを模倣し、718B MoEの訓練を開始した。この時、小型モデル実験室は再び動き出した。彼らはDeepseek v3を「套壳」して継続訓練することを選択した。彼らはDeepseekの読み込んだパラメータを凍結して訓練を行った。タスクがチェックポイントを読み込むディレクトリ名さえ「deepseekv3」のままで、変更すらしない。なんと傲慢なことか！それとは対照的に、真の技術的信念を持つ一部の同僚は、もう一つの718B MoEを一から訓練していた。しかし、その中で様々な問題が発生した。だが明らかに、このモデルが直接「套壳」したものより良いはずがない。もしチームリーダーが堅持していなければ、とっくに中止させられていただろう。
